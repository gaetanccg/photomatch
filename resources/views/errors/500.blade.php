...
<head>
    ...
    <title>Erreur serveur - PhotoMatch</title>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        <div class="text-center">
            <div class="flex justify-center mb-8">
                <div class="h-24 w-24 rounded-full bg-orange-100 flex items-center justify-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="javascript:location.reload()" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-emerald-600 hover:bg-emerald-700 transition">
            ...
            <div class="mt-8 p-4 bg-gray-100 rounded-lg max-w-md mx-auto">
                <p class="text-sm text-gray-600">
                    ...
                    Contactez notre support à <a href="mailto:support@photomatch.fr" class="text-emerald-600 hover:underline">support@photomatch.fr</a>
                </p>
            </div>
        </div>
