<x-client-layout>
    <div class="max-w-3xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-2xl font-bold text-gray-900">Nouveau projet</h1>
            <p class="mt-1 text-sm text-gray-600">Décrivez votre projet photo pour trouver le photographe idéal</p>
        </div>

        <!-- Form -->
        <form action="{{ route('client.projects.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                              placeholder="Décrivez votre projet en détail : type d'événement, ambiance souhaitée, nombre de personnes..."
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div id="event-date-wrapper" class="hidden">
                ...
                <!-- Hidden lat/lng fields for future geocoding -->
                ...
                <div>
                    ...
                    <input type="number" name="estimated_duration" id="estimated_duration" value="{{ old('estimated_duration') }}"
                           min="1"
                           class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                           placeholder="Ex: 8">
                ...
                <div class="pt-4 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="status" value="published" class="sr-only peer" {{ old('status') === 'published' ? 'checked' : '' }}>
